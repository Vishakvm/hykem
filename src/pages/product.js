                ...
                <div className="row">
                    <div className="col-md-6 hukemdiv d-flex justify-content-between flex-column p-3 p-md-5">
                        <div className="text-white">
                            <div className="pb-5"><a href="/"><img src="/img/hykem-logo.svg" alt="hykem Logo" className="img-fluid" /></a></div>                            <p>A global chemical company specializing in the sourcing, development and manufacture of eco-friendly, low-hazard, technically advanced chemical systems.</p>
